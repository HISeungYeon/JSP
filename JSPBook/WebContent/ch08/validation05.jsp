...
<script type="text/javascript">
	function checkMember(){
		let regExpId = /^[a-z|A-Z|ㄱ-ㅎ|ㅏ-ㅣ|가-힣]/; //영문 대문자/소문자, 한글, 한글의 자음과 모음으로 가능 
		let regExpName = /^[가-힣]*$/; //이름은 한글만 사용 가능 ^시작, $끝  *0ㅇㅣ상 반복
...
<body>
	...
	<form name="Member" method="post" action="validation05_process.jsp">
		...
		<p>연락처 : 
			...
			<input tpye="text" maxlength="4" size="4" name="phone2" /> -
			<input tpye="text" maxlength="4" size="4" name="phone3" />
		</p>
