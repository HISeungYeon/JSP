...
<body>
	...
	<p>
	웹 어플리케이션(JSPBook 프로젝트)의 보안을 위해 코드를 작성하여 사용자의 권한 부여를 처리하는 방식 
	</p>
	<p>
	선언적 시큐리티(tomcat-user.xml + web.xml)의 보안으로 충분하지 않을 때 request 내장 객체의 메소드를 사용하여 
	사용자를 승인
	</p>
	<p>사용자 명 : <%=request.getRemoteUser() %></p>
	<!-- .getAuthType() : BASIC 인지 FORM 인지 확인 -->
