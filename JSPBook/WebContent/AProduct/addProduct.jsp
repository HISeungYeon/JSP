...
<body>
	...
	<!-- 현재 로케일에 따라 리소스번들이 위치한 /src/bundle/ 패키지(디렉터리)에 message.properties를 
	가져오도록 basename 속성을 작성함 -->
		...
		class="form-horizontal" method="post" enctype="multipart/form-data">
			...
			<div class="form-group row">
			 	<div class="col-sm-offset-2 col-sm-10">
			 		...
			 		<a href="products.jsp" class="btn btn-light" ><fmt:message key='productList' /></a>
			 	</div>
			</div>
		</form>
	</div>
